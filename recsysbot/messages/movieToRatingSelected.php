...
function movieToRatingSelected($chatId, $pagerankCicle){
   ...
   file_put_contents("php://stderr", "movieToRatingSelected 0:".$reply[0]." - pagerankCicle:".$pagerankCicle.PHP_EOL);
   file_put_contents("php://stderr", "movieToRatingSelected 1:".$reply[1]." - pagerankCicle:".$pagerankCicle.PHP_EOL);
